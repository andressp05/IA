...
(defvar *alias* '|Riosal3.0|) ; alias que aparecer· en el ranking
...
(defun casillas-nulas (tablero lado pos)   ; funciones auxiliares usadas por heurÌstica
  (cond 
   ((< pos 3) 0)
...
(defvar *alias* '|Aiteda|) ; alias que aparecer· en el ranking
...
(defvar *alias* '|AitanaWar|) ; alias que aparecer· en el ranking
...
(defvar *alias* '|ejemplo|) ; alias que aparecer· en el ranking
