(defpackage :grupo01pareja082QA1804            ; se declara un paquete lisp que usa common-lisp
  (:use :common-lisp :mancala)                 ; y mancala, y exporta la función de evaluación
  (:export :heuristica :*alias*))              ; heurística y un alias para el torneo

(in-package grupo01pareja082QA1804)

(defvar *alias* '|Alfred no sabe hablar español|) ; alias que aparecerá en el ranking
