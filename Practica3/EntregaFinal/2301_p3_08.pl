...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                               EJERCICIO 1
%  Comprueba si un elemento esta en la lista o alguna de 
%  las sublistas
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%  Salida:
%    Tantos trues como veces pertenezca el elemento a la 
%    lista o cada uno de los valores que va tomando el 
%    elemento
pertenece(X, [X|_]).
...
%  Salida:
%    Tantos trues como veces pertenezca el elemento a la
%    lista o sublista o cada uno de los valores que va 
%    tomando el elemento
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                         EJERCICIO 2
%  Inserta un par de elementos en la lista de pares ordenados
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                        EJERCICIO 3
%  Inserta un par de elementos en una lista de pares 
%  ordenados en una posicion dada y desplazando el resto 
%  de elementos
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%  Salida:
%    R: lista con el par insertado en la posicion p y 
%    desplazados los de L.
insert(X, [], X).
insert([X-P], [Y-Q|Rs], R):- P =< Q -> 
    concatena([X-P], [Y-Q|Rs], R);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                       EJERCICIO 4.1
%  Comprueba que el elemento aparece un numero determinado 
%  de veces en una lista dada
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                       EJERCICIO 4.2
%  Comprueba que la lista contiene las ocurrencias de dos 
%  elementos en forma de par
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%  Salida:
%    L3: lista con los pares [elemento a contar-numero de veces 
%    que aparece]
list_count([], _, []).
list_count([X|RsX], Y, Xn):- elem_count(X, Y, Zn), 
    concatena([X-Zn], L, Xn), list_count(RsX, Y, L).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                        EJERCICIO 5
%  Comprueba que una lista contiene los elementos pares de la 
%  otra en orden
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
sort_list([], []).
sort_list([X-P|Rs], L2):- sort_list(Rs, LAux), 
    insert([X-P], LAux, L2).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                          EJERCICIO 6
%  Transforma una lista de pares ordenados en un arbol de 
%  Huffman simplificado
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%  Salida:
%    Tree: Arbol simplificado de Huffman 
%    creado a partir de la lista dada
build_tree([X-_], tree(X, nil, nil)).
build_tree([X-_|Rs], tree(1, T1, T2)):- 
    T1 = tree(X,nil,nil), 
    build_tree(Rs, T2).
...
%  Salida:
%    X2: version codificada del elemento X1 basado en el 
%    arbol Tree
encode_elem(X1,X2,tree(1, tree(X1, nil,nil), _)):- 
    concatena([], [0], X2).
encode_elem(X1,X2,tree(1,_, tree(X1, nil, nil))):- 
    concatena([], [1], X2).
encode_elem(X1,X2,tree(1, _ , RS)) :- 
    encode_elem(X1, AUX, RS), concatena([1], AUX, X2).

% Pruebas
% encode_elem(a, X, tree(1, tree(a, nil, nil), 
% tree(1, tree(b, nil, nil), tree(1, tree(c, nil, nil), 
% tree(d, nil, nil)))))
%
% encode_elem(b, X, tree(1, tree(a, nil, nil), 
% tree(1, tree(b, nil, nil), tree(1, tree(c, nil, nil), 
% tree(d, nil, nil)))))
% 
% encode_elem(c, X, tree(1, tree(a, nil, nil),
% tree(1, tree(b, nil, nil), tree(1, tree(c, nil, nil),
% tree(d, nil, nil)))))
% 
% encode_elem(d, X, tree(1, tree(a, nil, nil),
% tree(1, tree(b, nil, nil), tree(1, tree(c, nil, nil), 
% tree(d, nil, nil)))))
%------------------------------
...
%    Tree: estructura de arbol segun la cual se codificara
%  Salida:
%    L2: version codificada de la lista L1 basada en el arbol 
%    Tree
encode_list([], [], _).
encode_list([X1|RsX1], X2, Tree):- 
    encode_elem(X1, X2Aux, Tree), concatena([X2Aux], L, X2), 
    encode_list(RsX1, L, Tree).

% Pruebas
% encode_list([a], X, tree(1, tree(a, nil, nil), 
% tree(1, tree(b, nil, nil), tree(1, tree(c, nil, nil), 
% tree(d, nil, nil)))))
% 
% encode_list([a,a], X, tree(1, tree(a, nil, nil),
% tree(1, tree(b, nil, nil), tree(1, tree(c, nil, nil),
% tree(d, nil, nil)))))
% 
% encode_list([a,d,a], X, tree(1, tree(a, nil, nil),
% tree(1, tree(b, nil, nil), tree(1, tree(c, nil, nil),
% tree(d, nil, nil))))) 
% 
% encode_list([a,d,a,q], X, tree(1, tree(a, nil, nil),
% tree(1, tree(b, nil, nil), tree(1, tree(c, nil, nil),
% tree(d, nil, nil)))))
% 
% encode_list([a,b], X, tree(1, tree(a, nil, nil),
% tree(1, tree(b, nil, nil), tree(1, tree(c, nil, nil),
% tree(d, nil, nil)))))
%------------------------------
...
% Predicado facilitado para la realizacion del ejercicio 8,
...
%    L1: lista a codificar
%  Salida:
%    L2: versión codificada de la lista L2 usando el 
%    predicado dictionary
